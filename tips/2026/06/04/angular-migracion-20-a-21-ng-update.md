# Migración Angular 20→21 (2/4): Vitest por defecto

Serie de migración Angular paso a paso. Consulta la guía interactiva en [update.angular.io](https://update.angular.io/?v=20.0-21.0).

---

## Objetivo del día

Ejecuta `ng update` en una rama y resuelve conflictos de paquetes.
