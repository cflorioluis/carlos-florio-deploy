# Migración Angular 18→19 (3/4): breaking changes clave

Serie de migración Angular paso a paso. Consulta la guía interactiva en [update.angular.io](https://update.angular.io/?v=18.0-19.0).

---

## Objetivo del día

Aplica cambios de breaking changes y adapta plantillas, rutas y builders.
